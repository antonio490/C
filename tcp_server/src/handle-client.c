...
void eratosthenes( int num )
{
    ...
    /* Berechnung war nur Zeitvertrieb, Ergebnis verwerfen */
    free( np );
    return;
}
...
void handle_client( int client )
{
    ...
    {
        syslog( LOG_ERR, "writen() failed: %s", strerror( errno ) );
        return;
    }
    ...
    for(;;)
    {
        ...
        /* Specherplatz für das Ergebnis anfordern */
